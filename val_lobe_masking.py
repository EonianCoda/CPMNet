...
from networks.ResNet_3D_CPM_lobe_masking import DetectionPostprocess
### data ###
from dataload.dataset_lobe_masking import DetDataset
from dataload.utils import get_image_padding_value
from dataload.collate import infer_lobe_masking_collate_fn
from dataload.split_combine_lobe_masking import SplitComb
from torch.utils.data import DataLoader
import transform as transform

from logic.val_lobe_masking import val
...
def val_data_prepare(args):
    ...
    val_loader = DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False, num_workers=min(args.batch_size, args.max_workers) , collate_fn=infer_lobe_masking_collate_fn, pin_memory=True)
...
if __name__ == '__main__':
    ...
    for model_path in model_paths:
        ...
        save_folder_name = '{}_{}_lobe_masking'.format(os.path.basename(model_path).split('.')[0], os.path.basename(args.val_set).split('.')[0])
