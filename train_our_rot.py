...
### data ###
from dataload.dataset_fast_gpu import TrainDataset, DetDataset
...
def get_train_dataloder(args, blank_side=0) -> DataLoader:
    ...
    logger.info('Crop size: {}, overlap size: {}, pad value: {}, tp_ratio: {:.3f}, rand_trans: {}, rand_rot: {}, tp_iou = {:.3f}'.format(crop_size, overlap_size, pad_value, args.tp_ratio, rand_trans, args.rand_rot, args.tp_iou))
    crop_fn_train = InstanceCrop(crop_size=crop_size, overlap_size=overlap_size, tp_ratio=args.tp_ratio, rand_trans=rand_trans, rand_rot=args.rand_rot,
                                 sample_num=args.num_samples, blank_side=blank_side, instance_crop=True, tp_iou=args.tp_iou)
