...
class DownsamplingConvBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=2, norm_type='batchnorm', act_type='ReLU'):
        ...
        self.dw_conv = ConvBlock(in_channels, out_channels // 2, 1, norm_type=norm_type, act_type='none')
        
        self.conv_1 = ConvBlock(in_channels, out_channels // 2, 1, norm_type=norm_type, act_type='none')
        self.conv_2 = ConvBlock(out_channels // 2, out_channels // 2, 3, norm_type=norm_type, act_type='none', stride=stride)
        self.act = act_layer(act_type)
