...
class FPN3D(nn.Module):
    def __init__(self, n_filters, feature_size=64, norm_type='batchnorm', act_type='ReLU'):
        ...
        self.P4_elan = ELAN_Layer(2, feature_size * 2, feature_size, norm_type=norm_type, act_type=act_type)
        ...
        if len(n_filters) == 4:
            ...
            self.P3_elan = ELAN_Layer(2, feature_size * 2, feature_size, norm_type=norm_type, act_type=act_type)
    ...
    def forward(self, inputs):
        ...
        P4_x = self.P4_1(C4)
        P4_x = torch.cat([P4_x, P5_upsampled_x], 1)
        P4_x = self.P4_elan(P4_x)
        P4_upsampled_x = self.P4_upsampled(P4_x)
        # P4_x = self.P4_2(P4_x)

        P3_x = self.P3_1(C3)
        P3_x = torch.cat([P3_x, P4_upsampled_x], 1)
        P3_x = self.P3_elan(P3_x)
