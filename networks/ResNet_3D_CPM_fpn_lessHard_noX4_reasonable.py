...
from .modules import Identity, ConvBlock, act_layer, norm_layer3d
...
class ClsRegHead(nn.Module):
    def __init__(self, in_channels, feature_size=96, conv_num=2,
        ...
        self.cls_output = nn.Conv3d(feature_size, 1, kernel_size=1)
        self.shape_output = nn.Conv3d(feature_size, 3, kernel_size=1)
        self.offset_output = nn.Conv3d(feature_size, 3, kernel_size=1)
