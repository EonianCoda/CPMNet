...
class StemBlock(nn.Module):
    def __init__(self, in_channels, out_channels, norm_type='none', act_type='ReLU'):
        ...
        self.conv1 = ConvBlock(in_channels, feat_size, kernel_size=3, norm_type=norm_type, act_type='none')
        self.conv2 = ConvBlock(in_channels, feat_size, kernel_size=3, dilation=2, norm_type=norm_type, act_type='none')
        self.conv3 = ConvBlock(in_channels, feat_size, kernel_size=3, dilation=3, norm_type=norm_type, act_type='none')
