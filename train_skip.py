...
from networks.ResNet_3D_CPM_skip import Resnet18, DetectionPostprocess, DetectionLoss
### data ###
...
def add_weight_decay(net, weight_decay):
    ...
    for name, param in net.named_parameters():
        ...
        # skip head layer
        elif '.shape_output' in name or '.offset_output' in name:
           logger.info('Add {} in no decay'.format(name))
           no_decay.append(param)
        else:
            decay.append(param)
