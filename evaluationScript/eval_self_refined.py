...
class Evaluation:
    def __init__(self, 
        ...
        self._collect_gt(series_list_path, pred_path)
    ...
    def _collect_gt(self, series_list_path: str, pred_path: str):
        """
        ...
        if pred_path != '':
            ...
            self_refined_labels = get_self_refined_labels(series_predictions, self.image_spacing, conf_threshold=self.prob_threshold)
        ...
        for info in load_series_list(series_list_path):
            ...
            if series_name in self_refined_labels:
                refined_label = self_refined_labels[series_name]
