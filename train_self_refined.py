...
from logic.val_self_refined import val
...
def get_args():
    ...
    # Data
    parser.add_argument('--data_set_class', type=str, default='dataload.dataset_self_refined', help='data set class')
    ...
    parser.add_argument('--train_pred_path', type=str, required=True, help='train pred path')
    parser.add_argument('--val_pred_path', type=str, default='', help='val pred path')
...
def get_train_dataloder(args, blank_side=0) -> DataLoader:
    ...
    train_dataset = train_set_class(series_list_path = args.train_set, pred_path = args.train_pred_path, crop_fn = crop_fn_train, 
