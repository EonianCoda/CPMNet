...
class UnLabeledDataset(Dataset):
    def __init__(self, series_list_path: str, image_spacing: List[float], strong_aug = None, crop_fn=None, use_bg=False, 
        ...
        if use_gt_crop:
            raise NotImplementedError('Use ground truth crop is not implemented yet')
    ...
    def __getitem__(self, idx):
        ...
        if series_name in self.gt_labels:
        ...
        samples['file_name'] = series_name
        samples = self.crop_fn(samples, lobe, image_spacing, False)
        random_samples = []
