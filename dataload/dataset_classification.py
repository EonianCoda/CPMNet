...
class TrainDataset(Dataset):
    ...
    def __init__(self, series_list_path: str, image_spacing: List[float], transform_post=None, crop_fn=None, 
        ...
        self.nodule_size_ranges = [33.5, 113.1, 268.1]
        ...
        for i in range(len(samples)):
            ...
            if len(sample['rad']) != 0:
                ...
                for j in range(len(sample['rad'])):
                    ...
                    elif nodule_size < self.nodule_size_ranges[1] / 2:
                        r1 = self.nodule_size_ranges[0] / 2
                        r2 = self.nodule_size_ranges[1] / 2
                        ratio = (nodule_size - r1) / (r2 - r1)
                        all_cls.append([0, 1 - ratio, ratio, 0, 0])
                    elif nodule_size < self.nodule_size_ranges[2] / 2:
                        r1 = self.nodule_size_ranges[1] / 2
                        r2 = self.nodule_size_ranges[2] / 2
                        ratio = (nodule_size - r1) / (r2 - r1)
                        all_cls.append([0, 0, 1 - ratio, ratio, 0])
                    elif nodule_size < self.nodule_size_ranges[2] + self.nodule_size_ranges[2] / 2:
                        r1 = self.nodule_size_ranges[2] / 2
                        r2 = self.nodule_size_ranges[2] + self.nodule_size_ranges[2] / 2
                        ratio = (nodule_size - r1) / (r2 - r1)
