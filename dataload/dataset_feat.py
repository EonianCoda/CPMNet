...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(len(samples)):
            ...
            random_samples1.append(self.transform_post(copy.deepcopy(sample)))
            random_samples2.append(self.transform_post(sample))
            
        # random_samples1.extend(random_samples2)
        return random_samples1, random_samples2
