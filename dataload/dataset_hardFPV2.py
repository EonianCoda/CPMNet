...
from .utils import load_series_list, load_image, load_label, ALL_RAD, ALL_LOC, ALL_CLS, ALL_IOU, ALL_PROB, ALL_HARD_FP_LOC, ALL_HARD_FP_RAD, ALL_HARD_FP_PROB, gen_dicom_path, gen_label_path, normalize_processed_image, normalize_raw_image
...
class TrainDataset(Dataset):
    ...
    def __init__(self, series_list_path: str, image_spacing: List[float], transform_post=None, crop_fn=None, 
        ...
        self.hard_FP = []
        self.hard_fp_prob_threshold = None
    def __len__(self):
    ...
    def update_hard_FP(self, hard_FP, hard_fp_prob_threshold):
        self.hard_FP = hard_FP
        self.hard_fp_prob_threshold = hard_fp_prob_threshold
