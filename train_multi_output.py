...
def get_args():
    ...
    # Model
    parser.add_argument('--model_class', type=str, default='networks.ResNet_3D_CPM_fpn_lessHard_noX4_multi_output', help='model class')
...
def prepare_training(args, device, num_training_steps) -> Tuple[int, Any, AdamW, GradualWarmupScheduler, Any]:
    ...
    # build model
    detection_loss_s4 = DetectionLoss(crop_size = args.crop_size,
    ...
    detection_loss_s2 = DetectionLoss(crop_size = args.crop_size,
                                   pos_target_topk = args.pos_target_topk, 
                                   pos_ignore_ratio = args.pos_ignore_ratio,
                                   cls_num_neg = 80000,
                                   cls_num_hard = 800,
    ...
    model = Resnet18(norm_type = args.norm_type,
                     ...
                     detection_loss_s4 = detection_loss_s4,
                     detection_loss_s2 = detection_loss_s2,
