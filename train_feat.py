...
from dataload.collate import train_feat_collate_fn, infer_collate_fn
...
### logic ###
from logic.train_feat import train
from logic.val_feat import val
...
def get_args():
    ...
    # Data
    parser.add_argument('--data_set_class', type=str, default='dataload.dataset_feat', help='data set class')
    ...
    parser.add_argument('--lambda_feat', type=float, default=1.0, help='weights of feat loss')
    ...
    # Model
    parser.add_argument('--model_class', type=str, default='networks.ResNet_3D_CPM_fpn_lessHard_noX4_more_feat', help='model class')
...
def get_train_dataloder(args, blank_side=0) -> DataLoader:
    ...
    train_loader = DataLoader(train_dataset, 
                              ...
                              shuffle=True,
                              collate_fn=train_feat_collate_fn,
