...
from networks.ResNet_3D_CPM_regv1 import Resnet18, DetectionPostprocess, DetectionLoss
### data ###
...
def get_args():
    ...
    parser.add_argument('--iou_type', type=str, default='ciou', help='iou type, diou or ciou or wiou or eiou or eiou_focal')
    parser.add_argument('--iou_focal_alpha', type=float, default=1.0, help='alpha of regression focal loss')
...
def prepare_training(args, device, num_training_steps) -> Tuple[int, Resnet18, AdamW, GradualWarmupScheduler, DetectionPostprocess]:
    ...
    detection_loss = DetectionLoss(crop_size = args.crop_size,
                                   ...
                                   iou_focal_alpha = args.iou_focal_alpha)
