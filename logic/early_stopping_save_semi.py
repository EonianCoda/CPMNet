...
class EarlyStoppingSave:
    def __init__(self, target_metrics: List[str], save_dir: str, model_s, model_t, best: List[float] = None, best_epoch: List[int] = None):
    ...
    def _save_model(self, target_metric: str):
        save_states(self.best_model_save_paths[self.target_metrics.index(target_metric)], self.model_s, model_t=self.model_t)
    ...
    @staticmethod
    def load(save_dir: str, target_metrics: List[str], model_s, model_t):
        ...
        return EarlyStoppingSave(target_metrics, save_dir, model_s, model_t, best, best_epoch)