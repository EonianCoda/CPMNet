...
def get_args():
    ...
    # Network
    parser.add_argument('--model_class', type=str, default='network.ResNet_3D_CPM_fpn_lessHard', help='model class')
...
def prepare_training(args, device, num_training_steps) -> Tuple[int, Any, AdamW, GradualWarmupScheduler, Any]:
    logger.info('Prepare training based on "{}"'.format(args.model_class))
