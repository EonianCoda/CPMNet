...
def get_args():
    ...
    parser.add_argument('--det_post_process_class', type=str, default='networks.detection_post_process_matched')
...
if __name__ == '__main__':
    ...
    if args.apply_aug:
        ...
        from logic.val_matched import val
